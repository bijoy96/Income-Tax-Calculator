...
public class FemOrSixtyFiveCYesPrvt extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblDisplay6;
	...
	public  FemOrSixtyFiveCYesPrvt (JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay6 = new JLabel("Female or 65 Above  && CYes", SwingConstants.CENTER);
		lblDisplay6.setFont(new Font("Times New Roman",Font.PLAIN, 18));
    ...
    txtNetAsset.addMouseListener(new MouseAdapter() {
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<325000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:325000.So,You are not able to pay Income TAX");
					lblDisplay6.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>325000 && totalIncome<=725000){
					totalIncome=totalIncome-325000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>725000 && totalIncome<=1225000){
					totalIncome=totalIncome-725000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1225000 && totalIncome<=1825000){
						totalIncome=totalIncome-1225000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1825000 && totalIncome<=4825000){
						totalIncome=totalIncome-1825000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4825000){
						totalIncome=totalIncome-4825000;
