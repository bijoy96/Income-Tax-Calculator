...
public class DYesCNoPrvt extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblDisplay9;
	...
	public  DYesCNoPrvt  (JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay9 = new JLabel("Male && Disabled Yes && Private", SwingConstants.CENTER);
		lblDisplay9.setFont(new Font("Times New Roman",Font.PLAIN, 18));
    ...
    txtNetAsset.addMouseListener(new MouseAdapter() {
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<375000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:375000.So,You are not able to pay Income TAX");
					lblDisplay9.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>375000 && totalIncome<=775000){
					totalIncome=totalIncome-375000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>775000 && totalIncome<=1275000){
					totalIncome=totalIncome-775000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1275000 && totalIncome<=1875000){
						totalIncome=totalIncome-1275000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1875000 && totalIncome<=4875000){
						totalIncome=totalIncome-1875000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4875000){
						totalIncome=totalIncome-4875000;
