...
public class MalePrivateDisplay extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblSecondDisplay;
    JButton btnTaskCalculate,btnBack;
	...
	public MalePrivateDisplay(JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblSecondDisplay = new JLabel("Private Employee - Male", SwingConstants.CENTER);
		lblSecondDisplay.setFont(new Font("Times New Roman",Font.PLAIN, 18));
	...
	private void init() {
		...
		btnBack.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				lblSecondDisplay.setVisible(false);
				mainPanel.removeAll();
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(dMedical>dTempCmp && dTempCmp<120000){
					dMedical=dMedical-dTempCmp;
				}else if(dMedical>dTempCmp && dTempCmp>120000){
					dMedical=dMedical-120000;
				}else dMedical=0;
				...
				if(totalIncome<250000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:250000.So,You are not able to pay Income TAX");
					lblSecondDisplay.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
					
				}
				else if(totalIncome>250000 && totalIncome<=650000){
					totalIncome=totalIncome-250000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>650000 && totalIncome<=1150000){
					totalIncome=totalIncome-650000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1150000 && totalIncome<=1750000){
						totalIncome=totalIncome-1150000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1750000 && totalIncome<=4750000){
						totalIncome=totalIncome-1750000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4750000){
						totalIncome=totalIncome-4750000;
