...
public class FemOrSixtyFiveCNoPrvt extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblDisplay7;
	...
	public  FemOrSixtyFiveCNoPrvt  (JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay7 = new JLabel("Female or 65 Above  && Cno", SwingConstants.CENTER);
		lblDisplay7.setFont(new Font("Times New Roman",Font.PLAIN, 18));
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<300000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:300000.So,You are not able to pay Income TAX");
					lblDisplay7.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>300000 && totalIncome<=700000){
					totalIncome=totalIncome-300000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>700000 && totalIncome<=1200000){
					totalIncome=totalIncome-700000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1200000 && totalIncome<=1800000){
						totalIncome=totalIncome-1200000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1800000 && totalIncome<=4800000){
						totalIncome=totalIncome-1800000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4800000){
						totalIncome=totalIncome-4800000;
