...
public class FYesCNoPrvt extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblDisplay3;
	...
	public FYesCNoPrvt(JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay3 = new JLabel("Freedom Yes && Disable No && Private", SwingConstants.CENTER);
		lblDisplay3.setFont(new Font("Times New Roman",Font.PLAIN, 18));
...
txtBasicSalary.addMouseListener(new MouseAdapter() {
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<425000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:425000.So,You are not able to pay Income TAX");
					lblDisplay3.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>425000 && totalIncome<=825000){
					totalIncome=totalIncome-425000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>825000 && totalIncome<=1325000){
					totalIncome=totalIncome-825000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1325000 && totalIncome<=1925000){
						totalIncome=totalIncome-1325000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1925000 && totalIncome<=4925000){
						totalIncome=totalIncome-1925000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4925000){
						totalIncome=totalIncome-4925000;
