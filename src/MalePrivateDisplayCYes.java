...
public class MalePrivateDisplayCYes extends JPanel{
	...
	public MalePrivateDisplayCYes(JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay3 = new JLabel("Male && Disabled Yes && Private", SwingConstants.CENTER);
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<275000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:275000.So,You are not able to pay Income TAX");
					lblDisplay3.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>275000 && totalIncome<=675000){
					totalIncome=totalIncome-275000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>675000 && totalIncome<=1175000){
					totalIncome=totalIncome-675000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1175000 && totalIncome<=1775000){
						totalIncome=totalIncome-1175000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1775000 && totalIncome<=4775000){
						totalIncome=totalIncome-1775000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4775000){
						totalIncome=totalIncome-4775000;
