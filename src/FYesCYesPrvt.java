...
public class FYesCYesPrvt extends JPanel{
	
	private JPanel mainPanel;	
	private JLabel lblDisplay5;
	...
	public FYesCYesPrvt(JPanel mainPanel) {
		this.mainPanel = mainPanel;
		lblDisplay5 = new JLabel("Male && Disabled Yes && Private", SwingConstants.CENTER);
		lblDisplay5.setFont(new Font("Times New Roman",Font.PLAIN, 18));
		...
		btnTaskCalculate.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(totalIncome<450000){
					JOptionPane.showMessageDialog(null, "Your Total Income is less than BDT:450000.So,You are not able to pay Income TAX");
					lblDisplay5.setVisible(false);
					mainPanel.removeAll();
					mainPanel.add(new MainDisplay(mainPanel));
				}
				else if(totalIncome>450000 && totalIncome<=850000){
					totalIncome=totalIncome-450000;
					incomeTax=incomeTax+(totalIncome*.10);
				}else if(totalIncome>850000 && totalIncome<=1350000){
					totalIncome=totalIncome-850000;
					incomeTax=40000;
					incomeTax=incomeTax+(totalIncome*.15);
					}else if(totalIncome>1350000 && totalIncome<=1950000){
						totalIncome=totalIncome-1350000;
						incomeTax=40000+75000;
						incomeTax=incomeTax+(totalIncome*.20);
					}else if(totalIncome>1950000 && totalIncome<=4950000){
						totalIncome=totalIncome-1950000;
						incomeTax=40000+75000+120000;
						incomeTax=incomeTax+(totalIncome*.25);
					}else if(totalIncome>4950000){
						totalIncome=totalIncome-4950000;
